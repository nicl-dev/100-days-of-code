...
completed_timers = Label(bg=YELLOW, fg=GREEN, text="🗸", font=(FONT_NAME, 35, "bold"))
completed_timers.grid(row=2, column=1)

start_timer = Button(text="Start")
start_timer.grid(row=2, column=0)

reset_timer = Button(text="Reset")
